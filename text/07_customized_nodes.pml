[ch (id=customizing_syntax) [title Customizing Syntax]
    ...
    Let's look at an example of syntax customization in [!get PML_link].
    ...
    [insert_code file=[!get examples_dir]customizing_syntax/HTML_example.pml]
    ...
    [insert_code file=[!get examples_dir]customizing_syntax/icon_function.def]

    Now we can easily insert icons with the following code:
    [insert_code file=[!get examples_dir]customizing_syntax/function_usage.pml]
    ...
    [insert_code file=[!get examples_dir]customizing_syntax/icon_function_2.def]

    Now, this code:
    [insert_code file=[!get examples_dir]customizing_syntax/function_2_usage.pml]
